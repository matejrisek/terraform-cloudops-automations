resource "aws_iam_role" "codedeploy_role" {
  name =  "${var.NameSpace}_${var.AccountEnv}_codedeploy_role"
  description = "${var.NameSpace}_${var.AccountEnv}_codedeploy_role"
...
resource "aws_iam_role_policy_attachment" "codedeploy_role_cm_policy_attachment" {
