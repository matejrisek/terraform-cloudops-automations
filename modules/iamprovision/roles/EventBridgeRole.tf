resource "aws_iam_role" "eventbridge_role" {
  name =  "${var.NameSpace}_${var.AccountEnv}_eventbridge_role"
  description = "${var.NameSpace}_${var.AccountEnv}_eventbridge_role"
...
resource "aws_iam_role_policy_attachment" "eventbridge_role_cm_policy_attachment" {
